...
const translations = {
  zh: {
    ...
    "profiles.editor.sections.statusLine": "状态栏",
    ...
    "presets.editor.sections.statusLine": "状态栏",
    ...
    "profileEditor.statusLine.title": "状态栏",
    "profileEditor.statusLine.summaryHint": "配置 Claude Code 自定义状态栏命令。",
    "profileEditor.statusLine.commandLabel": "状态栏命令",
    "profileEditor.statusLine.commandPlaceholder": "例如：~/.claude/statusline.sh",
    "profileEditor.statusLine.paddingLabel": "状态栏填充",
    "profileEditor.statusLine.paddingPlaceholder": "默认 0，可留空",
    "profileEditor.statusLine.refreshIntervalLabel": "状态栏刷新间隔",
    "profileEditor.statusLine.refreshIntervalPlaceholder": "仅事件触发时可留空",
    "profileEditor.statusLine.errorType": '状态栏类型必须为 "command"',
    "profileEditor.statusLine.errorCommandRequired": "状态栏命令不能为空",
    "profileEditor.statusLine.errorPaddingNumber": "状态栏填充必须是数字",
    "profileEditor.statusLine.errorRefreshIntervalInteger": "状态栏刷新间隔必须是整数",
    "profileEditor.statusLine.errorRefreshIntervalMin": "状态栏刷新间隔必须大于或等于 1",
    "profileEditor.statusLine.errorJsonType": '状态栏 JSON 中的 type 必须为 "command"',
    "profileEditor.statusLine.errorJsonCommandRequired": "状态栏 JSON 中的 command 不能为空",
    "profileEditor.statusLine.errorJsonPaddingNumber": "状态栏 JSON 中的 padding 必须是数字",
    "profileEditor.statusLine.errorJsonRefreshIntervalInteger":
      "状态栏 JSON 中的 refreshInterval 必须是整数",
    "profileEditor.statusLine.errorJsonRefreshIntervalMin":
      "状态栏 JSON 中的 refreshInterval 必须大于或等于 1",
