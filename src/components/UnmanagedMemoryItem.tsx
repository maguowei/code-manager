...
function UnmanagedMemoryItem({ memory, onImport }: UnmanagedMemoryItemProps) {
  ...
  return (
    <Card
      className="memory-item memory-item-unmanaged relative flex cursor-default flex-col gap-4 rounded-lg border border-dashed border-border bg-card p-4 text-foreground shadow-none transition-[transform,border-color,box-shadow,background-color,opacity] duration-200 hover:-translate-y-px hover:border-chart-3 hover:bg-accent/40 hover:shadow-sm"
