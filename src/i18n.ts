...
const translations = {
  zh: {
    ...
    "codex.field.profileNamePlaceholder": "例如：DeepSeek 快速起步",
    "codex.field.description": "描述",
    "codex.field.descriptionPlaceholder": "可选备注描述",
  ...
  en: {
    ...
    "codex.field.profileNamePlaceholder": "e.g. DeepSeek Fast",
    "codex.field.description": "Description",
    "codex.field.descriptionPlaceholder": "Optional profile description",
