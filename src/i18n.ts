...
const translations = {
  zh: {
    ...
    "configModal.baseUrlHint": "填写 ANTHROPIC_BASE_URL 对应的 Base URL，不要填写完整接口路径",
  ...
  en: {
    ...
    "configModal.baseUrl": "Base URL",
    "configModal.baseUrlPlaceholder": "https://api.anthropic.com",
    "configModal.baseUrlHint": "Enter the ANTHROPIC_BASE_URL base URL, not a full endpoint such as /v1/messages",
