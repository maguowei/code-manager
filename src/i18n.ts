...
const translations = {
  zh: {
    ...
    "codex.pageDescription":
      "管理 OpenAI Codex CLI 的 provider 与配置切换(外科补丁写入 ~/.codex)。",
    "codex.addProvider": "新增 Provider",
    "codex.loading": "加载中…",
    "codex.edit": "编辑",
    "codex.delete": "删除",
    "codex.cancel": "取消",
    "codex.save": "保存",
    "codex.openDocs": "打开文档",
    "codex.builtinBadge": "内置",
    "codex.emptyProviderTitle": "尚无 Codex Provider",
    "codex.emptyProviderHint": "新增一个自定义 Provider,或使用内置 OpenAI 官方快速起步。",
    "codex.providerSectionHint": "内置 Provider 只读;自定义 Provider 可编辑与删除。",
    "codex.providerMetaEnvKey": "环境变量键:",
    ...
    "codex.deleteProviderDescription":
      "确认删除该自定义 Codex Provider?被 Codex Profile 引用时,删除将被阻止。",
    "codex.field.name": "名称",
    ...
    "codex.field.envKeyHint":
      "环境变量键名(展示用);应用时密钥统一写入 ~/.codex/auth.json 的 OPENAI_API_KEY。",
    "codex.field.wireApi": "wire_api",
    "codex.field.wireApiHint": "responses(Codex 已移除 chat,这是当前唯一支持的协议)。",
    ...
    "codex.toast.providerSaveFailed": "保存 Codex Provider 失败",
    "codex.toast.providerDeleted": "Codex Provider 已删除",
    "codex.toast.providerDeleteFailed": "删除 Codex Provider 失败",
    "codex.providerSectionTitle": "Provider",
    "codex.profileSectionTitle": "配置",
    "codex.profileSectionHint":
      "每份配置引用一个 Provider 并叠加一个 API key;Apply 时外科补丁写入 ~/.codex。",
    ...
    "codex.applyPreviewDescription":
      "将以外科补丁方式改写 ~/.codex/config.toml 的 provider 段,并把认证切换为 api_key 模式(写入 auth.json);其余键原样保留。",
    "codex.applyPreviewCurrent": "当前活跃 provider",
    "codex.applyPreviewNext": "切换到",
    "codex.applyPreviewRemovedSection": "将移除旧 provider 段",
    "codex.applyPreviewAuth": "认证",
    "codex.applyPreviewAuthSet": "将写入 API key 到 auth.json,并切换为 api_key 模式",
  ...
  en: {
    ...
    // Codex 配置(ADR 0004 平行独立模型)
    "codex.pageTitle": "Codex Config",
    "codex.pageDescription":
      "Manage OpenAI Codex CLI providers and config switching (surgical-patch writes to ~/.codex).",
    "codex.addProvider": "Add Provider",
    "codex.loading": "Loading…",
    "codex.edit": "Edit",
    "codex.delete": "Delete",
    "codex.cancel": "Cancel",
    "codex.save": "Save",
    "codex.openDocs": "Open docs",
    "codex.builtinBadge": "Built-in",
    "codex.emptyProviderTitle": "No Codex provider yet",
    "codex.emptyProviderHint":
      "Add a custom provider, or start quickly with the built-in OpenAI official one.",
    "codex.providerSectionHint":
      "Built-in providers are read-only; custom providers can be edited and deleted.",
    "codex.providerMetaEnvKey": "Env key:",
    "codex.providerMetaWireApi": "wire_api:",
    "codex.createProvider": "New Codex Provider",
    "codex.editProvider": "Edit Codex Provider",
    "codex.editorDescription":
      "A Codex Provider only carries connection info (base_url, env_key, wire_api), not the API key.",
    "codex.deleteProviderTitle": "Delete Codex Provider",
    "codex.deleteProviderDescription":
      "Delete this custom Codex provider? Deletion is blocked while profiles reference it.",
    "codex.field.name": "Name",
    "codex.field.namePlaceholder": "e.g. My relay",
    "codex.field.baseUrl": "Base URL",
    "codex.field.baseUrlHint":
      "OpenAI-compatible API URL, written to [model_providers.NAME].base_url.",
    "codex.field.envKey": "Env var key",
    "codex.field.envKeyHint":
      "Env var key name (display only); on Apply the key is written to OPENAI_API_KEY in ~/.codex/auth.json.",
    "codex.field.wireApi": "wire_api",
    "codex.field.wireApiHint":
      "responses (Codex removed chat; this is the only supported protocol).",
    ...
    "codex.toast.providerSaveFailed": "Failed to save Codex provider",
    "codex.toast.providerDeleted": "Codex provider deleted",
    "codex.toast.providerDeleteFailed": "Failed to delete Codex provider",
    ...
    "codex.field.profileNamePlaceholder": "e.g. Work relay",
    "codex.field.provider": "Provider",
    "codex.field.providerPlaceholder": "Select a provider",
    "codex.field.apiKey": "API key",
    "codex.field.apiKeyHint":
      "ApiKey mode only; written to ~/.codex/auth.json and switches auth to api_key mode on Apply.",
    ...
    "codex.applyPreviewDescription":
      "This surgically patches the provider section of ~/.codex/config.toml and switches auth to api_key mode (writes auth.json); all other keys are preserved.",
    "codex.applyPreviewCurrent": "Current active provider",
    "codex.applyPreviewNext": "Switch to",
    "codex.applyPreviewRemovedSection": "Will remove old provider section",
    "codex.applyPreviewAuth": "Auth",
    "codex.applyPreviewAuthSet": "Will write API key to auth.json and switch to api_key mode",
