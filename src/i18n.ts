...
const translations = {
  zh: {
    ...
    "codex.field.envKeyHint":
      "环境变量键名,写入 [model_providers.NAME].env_key;应用时 API key 写入 ~/.codex/auth.json。",
    ...
    "codex.field.apiKeyHint": "仅 ApiKey 模式;Apply 时写入 ~/.codex/auth.json 的 OPENAI_API_KEY。",
    ...
    "codex.applyPreviewAuthSet": "将写入 API key 到 ~/.codex/auth.json",
  ...
  en: {
    ...
    "codex.field.envKeyHint":
      "Env var key name, written to [model_providers.NAME].env_key; on Apply the API key is written to ~/.codex/auth.json.",
    "codex.field.wireApi": "wire_api",
    ...
    "codex.field.apiKeyHint":
      "ApiKey mode only; written to OPENAI_API_KEY in ~/.codex/auth.json on Apply.",
    ...
    "codex.applyPreviewAuthSet": "Will write API key to ~/.codex/auth.json",
