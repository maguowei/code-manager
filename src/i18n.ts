...
const translations = {
  zh: {
    ...
    "codex.noCustomProvider": "尚未添加自定义 Provider。",
    ...
    "codex.deleteProviderDescription":
      "确认删除该自定义 Codex Provider?引用它的 Codex Profile 需另行处理。",
    "codex.field.name": "名称",
    ...
    "codex.field.envKeyHint": "读取 API key 的环境变量名(如 OPENAI_API_KEY),写入 env_key。",
    "codex.field.wireApi": "wire_api",
    "codex.field.wireApiHint": "responses 或 chat,决定请求协议。",
    ...
    "codex.field.apiKeyHint": "仅 ApiKey 模式;Apply 时写入 ~/.codex/auth.json。",
  ...
  en: {
    ...
    "codex.providerMetaWireApi": "wire_api:",
    "codex.noCustomProvider": "No custom provider added yet.",
    ...
    "codex.deleteProviderDescription":
      "Delete this custom Codex provider? Profiles referencing it must be handled separately.",
    ...
    "codex.field.envKeyHint":
      "Name of the env var holding the API key (e.g. OPENAI_API_KEY), written to env_key.",
    "codex.field.wireApi": "wire_api",
    "codex.field.wireApiHint": "responses or chat, decides the request protocol.",
    ...
    "codex.field.apiKey": "API key",
    "codex.field.apiKeyHint": "ApiKey mode only; written to ~/.codex/auth.json on Apply.",
