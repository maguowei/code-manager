...
const translations = {
  zh: {
    ...
    "profiles.editor.modelTest.viewRawResponse": "查看完整响应",
    "profiles.editor.modelTest.hideRawResponse": "隐藏完整响应",
    "profiles.editor.modelTest.rawResponse": "完整响应",
    "presets.title": "预设",
    "presets.add": "新增预设",
  ...
  en: {
    ...
    "profiles.editor.modelTest.viewRawResponse": "View Full Response",
    "profiles.editor.modelTest.hideRawResponse": "Hide Full Response",
    "profiles.editor.modelTest.rawResponse": "Full Response",
