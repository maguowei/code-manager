              ...
              <div className="flex h-[42px] min-w-[150px] flex-[1_1_0] items-center gap-2 rounded-md border border-border bg-card px-2.5 transition-[border-color,box-shadow,transform] focus-within:border-[var(--primary)] focus-within:ring-[3px] focus-within:ring-ring/50 hover:border-muted-foreground max-[520px]:flex-auto">
                ...
                >
                  <SelectTrigger
                    ...
                    onChange={(event) =>
                      setStatusFilter(
                        (event.target as HTMLButtonElement).value as PluginStatusFilter,
                      )
                    }
                  >
                    <SelectValue />
              ...
              <div className="flex h-[42px] min-w-[150px] flex-[1_1_0] items-center gap-2 rounded-md border border-border bg-card px-2.5 transition-[border-color,box-shadow,transform] focus-within:border-[var(--primary)] focus-within:ring-[3px] focus-within:ring-ring/50 hover:border-muted-foreground max-[520px]:flex-auto">
                ...
                <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                  <SelectTrigger
                    ...
                    onChange={(event) =>
                      setCategoryFilter((event.target as HTMLButtonElement).value)
                    }
                  >
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex h-[42px] min-w-[150px] flex-[1_1_0] items-center gap-2 rounded-md border border-border bg-card px-2.5 transition-[border-color,box-shadow,transform] focus-within:border-[var(--primary)] focus-within:ring-[3px] focus-within:ring-ring/50 hover:border-muted-foreground max-[520px]:flex-auto">
                ...
                <Select value={sourceTypeFilter} onValueChange={setSourceTypeFilter}>
                  <SelectTrigger
                    ...
                    data-value={sourceTypeFilter}
                    onChange={(event) =>
                      setSourceTypeFilter((event.target as HTMLButtonElement).value)
                    }
                  >
                    <SelectValue />
                  </SelectTrigger>
