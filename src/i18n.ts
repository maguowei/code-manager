...
const translations = {
  zh: {
    ...
    "usage.charts.byModel": "按模型成本占比",
    "usage.charts.tokenBreakdown": "Token 类型构成",
  ...
  en: {
    ...
    "usage.charts.byModel": "Cost share by model",
    "usage.charts.tokenBreakdown": "Token type breakdown",
