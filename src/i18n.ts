...
const translations = {
  zh: {
    ...
    "nav.providers": "供应商",
    "profiles.title": "配置",
    "profiles.productSwitcher.ariaLabel": "配置类型",
    "profiles.productSwitcher.claude": "Claude Code",
    "profiles.productSwitcher.codex": "Codex",
    ...
    "usage.charts.cacheHitRateExcellent": "优秀 ≥90%",
    "usage.charts.cacheHitRateGood": "良好 ≥70%",
    ...
    // Codex 配置(ADR 0004 平行独立模型)
    "codex.pageTitle": "Codex 配置",
    "codex.pageDescription":
      "管理 OpenAI Codex CLI 的 Profile，支持内置厂商预设与自定义配置片段，Apply 时以外科补丁方式写入 ~/.codex。",
    "codex.loading": "加载中…",
    "codex.edit": "编辑",
    "codex.delete": "删除",
    "codex.cancel": "取消",
    ...
    "codex.emptyProfileHint":
      "点击「新增配置」，选择 DeepSeek / 智谱 GLM / MiniMax / 小米 MiMo / OpenAI 官方预设或直接输入自定义配置片段快速起步。",
    "codex.createProfile": "新增 Codex 配置",
    "codex.editProfile": "编辑 Codex 配置",
    "codex.profileEditorDescription":
      "支持一键选用主流模型厂商预设或编写自定义 config.toml / models.json 配置片段。",
    "codex.deleteProfileTitle": "删除 Codex 配置",
    "codex.deleteProfileDescription": "确认删除该 Codex 配置？",
    "codex.modePreset": "厂商预设",
    "codex.modeCustom": "自定义片段",
    "codex.selectPresetTitle": "选择供应商预设",
    "codex.selectPresetHint": "选择主流模型厂商即可自动填充推荐模型、Base URL 与 Model Catalog。",
    "codex.field.profileName": "配置名称",
    "codex.field.profileNamePlaceholder": "例如：DeepSeek-日常开发",
    "codex.field.description": "描述",
    "codex.field.descriptionPlaceholder": "例如：日常代码编写与快速审查",
    "codex.field.model": "目标模型",
    "codex.field.modelPlaceholder": "选择或输入模型名称，如 deepseek-v4-flash",
    "codex.field.modelHint": "写入 config.toml 的顶层 model 字段。切换 Profile 时自动生效。",
    "codex.field.reasoningEffort": "推理档位 (Reasoning Effort)",
    ...
    "codex.field.apiKeyHint":
      "Apply 时内联进 config.toml 的 experimental_bearer_token，不写入 ~/.codex/auth.json。",
    "codex.field.chatgptLoginHint":
      "内置 OpenAI 官方使用 ChatGPT 登录（codex login），无需配置 API Key；Apply 不会改写 ~/.codex/auth.json。",
    "codex.field.apiKeyKeepHint": "留空保留已有 API Key",
    "codex.field.showApiKey": "显示 API Key",
    "codex.field.hideApiKey": "隐藏 API Key",
    "codex.field.customToml": "config.toml 配置片段",
    "codex.field.customTomlPlaceholder":
      'model_provider = "my_provider"\nmodel = "custom-model"\n\n[model_providers.my_provider]\nname = "My Provider"\nbase_url = "https://..."\nexperimental_bearer_token = "sk-..."\nwire_api = "responses"',
    "codex.field.customTomlHint":
      "将以外科合并方式将片段中的键合并到 ~/.codex/config.toml 中，保留原有其他设置。",
    "codex.field.customJson": "models.json 模型目录片段（可选）",
    "codex.field.customJsonPlaceholder":
      '{\n  "my-custom-model": {\n    "context_window": 128000,\n    "display_name": "My Custom Model"\n  }\n}',
    "codex.field.customJsonHint":
      "填写有效的 JSON 对象，Apply 时生成到 ~/.codex/models.json 并配置 model_catalog_json。",
    "codex.modelCatalogIncluded": "内置包含模型目录定义（models.json）",
    "codex.summary.model": "模型",
    "codex.summary.effort": "推理档位",
    "codex.summary.apiKey": "API Key",
    "codex.summary.chatgptLogin": "ChatGPT 登录",
    "codex.summary.apiKeyUnset": "未配置",
    "codex.summary.customSnippet": "自定义片段",
    "codex.badges.inUse": "使用中",
    ...
    "codex.apply": "应用",
    "codex.applied": "已生效",
    "codex.activeBadge": "当前激活",
    "codex.editingBadge": "编辑中",
    "codex.toast.profileApplied": "Codex 配置已应用",
    "codex.toast.profileApplyFailed": "应用 Codex 配置失败",
    "codex.applyPreviewTitle": "应用 Codex 配置预览",
    "codex.applyPreviewDescription":
      "将以外科补丁方式更新 ~/.codex/config.toml（及可选的 models.json），不触碰 auth.json。请核对完整配置内容：",
    "codex.previewTabToml": "config.toml 完整预览",
    "codex.previewTabModels": "models.json 模型目录",
    "codex.applyPreviewCurrent": "当前活跃 Provider",
    "codex.applyPreviewNext": "将切换为",
  ...
  en: {
    ...
    "profiles.productSwitcher.ariaLabel": "Profile type",
    "profiles.productSwitcher.claude": "Claude Code",
    "profiles.productSwitcher.codex": "Codex",
    ...
    "usage.charts.cacheHitRateExcellent": "Excellent ≥90%",
    ...
    // Codex 配置(ADR 0004 平行独立模型)
    "codex.pageTitle": "Codex Profiles",
    "codex.pageDescription":
      "Manage OpenAI Codex CLI profiles with vendor presets or custom config snippets. Apply writes a surgical patch to ~/.codex.",
    ...
    "codex.emptyProfileTitle": "No Codex profiles yet",
    "codex.emptyProfileHint":
      'Click "Add Profile" to choose DeepSeek / Zhipu GLM / MiniMax / Xiaomi MiMo / OpenAI official presets or input custom config snippets.',
    "codex.createProfile": "New Codex Profile",
    "codex.editProfile": "Edit Codex Profile",
    "codex.profileEditorDescription":
      "Choose from mainstream vendor presets or author custom config.toml / models.json snippets.",
    "codex.deleteProfileTitle": "Delete Codex Profile",
    "codex.deleteProfileDescription": "Delete this Codex profile?",
    "codex.modePreset": "Vendor Preset",
    "codex.modeCustom": "Custom Snippet",
    "codex.selectPresetTitle": "Select Vendor Preset",
    "codex.selectPresetHint":
      "Selecting a preset vendor auto-populates recommended models, Base URL, and Model Catalog.",
    "codex.field.profileName": "Profile Name",
    "codex.field.profileNamePlaceholder": "e.g. DeepSeek-Daily Dev",
    "codex.field.description": "Description",
    "codex.field.descriptionPlaceholder": "e.g. Daily coding and fast review",
    "codex.field.model": "Target Model",
    "codex.field.modelPlaceholder": "Select or enter model name, e.g. deepseek-v4-flash",
    "codex.field.modelHint": "Written to top-level model field in config.toml on Apply.",
    ...
    "codex.field.apiKeyPlaceholder": "sk-...",
    "codex.field.apiKeyHint":
      "Inlined as experimental_bearer_token in config.toml on Apply; never written to ~/.codex/auth.json.",
    "codex.field.chatgptLoginHint":
      "The built-in OpenAI preset uses ChatGPT login (codex login); no API Key required.",
    "codex.field.apiKeyKeepHint": "Leave blank to keep existing API Key",
    "codex.field.showApiKey": "Show API Key",
    "codex.field.hideApiKey": "Hide API Key",
    "codex.field.customToml": "config.toml snippet",
    "codex.field.customTomlPlaceholder":
      'model_provider = "my_provider"\nmodel = "custom-model"\n\n[model_providers.my_provider]\nname = "My Provider"\nbase_url = "https://..."\nexperimental_bearer_token = "sk-..."\nwire_api = "responses"',
    "codex.field.customTomlHint":
      "Surgically merged into ~/.codex/config.toml, preserving other custom keys.",
    "codex.field.customJson": "models.json snippet (optional)",
    "codex.field.customJsonPlaceholder":
      '{\n  "my-custom-model": {\n    "context_window": 128000,\n    "display_name": "My Custom Model"\n  }\n}',
    "codex.field.customJsonHint":
      "Valid JSON map generated to ~/.codex/models.json and referenced by model_catalog_json on Apply.",
    "codex.modelCatalogIncluded": "Includes built-in model catalog (models.json)",
    "codex.summary.model": "Model",
    "codex.summary.effort": "Effort",
    "codex.summary.apiKey": "API Key",
    "codex.summary.chatgptLogin": "ChatGPT Login",
    "codex.summary.apiKeyUnset": "Not configured",
    "codex.summary.customSnippet": "Custom Snippet",
    "codex.badges.inUse": "In Use",
    ...
    "codex.apply": "Apply",
    "codex.applied": "Applied",
    "codex.activeBadge": "Active",
    "codex.editingBadge": "Editing",
    "codex.toast.profileApplied": "Codex profile applied",
    "codex.toast.profileApplyFailed": "Failed to apply Codex profile",
    "codex.applyPreviewTitle": "Codex Apply Preview",
    "codex.applyPreviewDescription":
      "This surgically patches ~/.codex/config.toml (and optional models.json) without touching auth.json. Review full config:",
    "codex.previewTabToml": "config.toml Full Preview",
    "codex.previewTabModels": "models.json Catalog Preview",
    "codex.applyPreviewCurrent": "Current active Provider",
    "codex.applyPreviewNext": "Switching to",
